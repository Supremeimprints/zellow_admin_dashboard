                    ...
                    <form id="filterForm" class="row g-3">
                        ...
                        <div class="col-md-2">
                            ...
                            <select name="payment_method" class="form-select">
                                ...
                                <option value="Manual" <?= $filters['payment_method'] === 'Manual' ? 'selected' : '' ?>>Manual</option>
                                <option value="Refund" <?= $filters['payment_method'] === 'Refund' ? 'selected' : '' ?>>Refund</option>
                            </select>
                        </div>
                        <div class="col-md-2">
                                ...
                                <?php if (is_array($transactions) && !empty($transactions)): ?>
                                    <?php foreach ($transactions as $transaction): ?>
                                        <tr>
                                            ...
                                            <td>
                                                <span class="badge bg-<?= getTransactionBadgeClass($transaction['payment_method']) ?>">
                                            ...
                                            <td>
                                                <span class="badge bg-<?= getStatusBadgeClass($transaction['payment_status']) ?>">
